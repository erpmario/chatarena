...
class TestHFTransformers(TestCase):
	...
	def test_transformers_conv_1(self):
		...
		history_messages = [
			Message(
				agent_name = "User",
				content = "Hello, I want to cook pasta, can you give me a recipe?",
				turn = 1,
			),
		]
	...
	def test_transformers_conv_2(self):
		...
		history_messages = [
			...
			Message(
				agent_name = "Chatbot",
				content = "Sure, what kind of pasta do you like? I like spaghetti and meatballs.",
				turn = 2,
			),
			Message(
				agent_name = "User",
				content = "I like Bucatini better. Could you suggest a recipe?",
				turn = 3,
			),
		]
